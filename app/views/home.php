                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/<?=$object['']?>" alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="bi bi-cart-fill"></i></a>
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="bi bi-heart-fill"></i>
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href=""><?=$object['obj_name']?></a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>$<?=$object['prix']?></h5>
                                    <h6 class="text-muted ml-2"><del>$<?=$object['prix']?></del></h6>
                                </div>
